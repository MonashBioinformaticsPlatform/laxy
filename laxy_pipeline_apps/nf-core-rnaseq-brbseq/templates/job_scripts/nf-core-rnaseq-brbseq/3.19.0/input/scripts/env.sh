...
export LAXYDL_BRANCH=${LAXYDL_BRANCH:-master}  # unused when using apptainer instead
...
export LAXYDL_CONTAINER_IMAGE="ghcr.io/monashbioinformaticsplatform/laxy/laxy-downloader:41d7be5"
