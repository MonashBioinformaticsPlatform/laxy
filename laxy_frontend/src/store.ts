...
export const SET_PIPELINE_CUSTOM_GENOME_FASTA_URL = 'set_pipeline_custom_genome_fasta_url';
export const SET_PIPELINE_CUSTOM_GENOME_ANNOTATION_URL = 'set_pipeline_custom_genome_annotation_url';
...
const mutations: any = {
    ...
    // },
    // [SET_PIPELINE_CUSTOM_GENOME_FASTA_URL](state: any, url: any) {
    //     state.pipelineParams.custom_genome.fasta_url = url;
    // },
    // [SET_PIPELINE_CUSTOM_GENOME_ANNOTATION_URL](state: any, url: any) {
    //     state.pipelineParams.custom_genome.annotation_url = url;
    // },
