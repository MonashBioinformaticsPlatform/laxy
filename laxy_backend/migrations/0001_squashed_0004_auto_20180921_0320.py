# Generated by Django 2.0.8 on 2018-11-21 02:37
...
class Migration(migrations.Migration):
    ...
    replaces = [('laxy_backend', '0001_initial'), ('laxy_backend', '0002_userprofile_avatar_url'), ('laxy_backend', '0003_auto_20180921_0310'), ('laxy_backend', '0004_auto_20180921_0320')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='compute_resources', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('path', models.CharField(blank=True, max_length=4096, null=True)),
                ('owner', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='filesets', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'get_latest_by': ['-modified_time'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='jobs', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'get_latest_by': ['-modified_time'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='pipeline_runs', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'get_latest_by': ['-modified_time'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='samplesets', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'get_latest_by': ['-modified_time'],
                'abstract': False,
