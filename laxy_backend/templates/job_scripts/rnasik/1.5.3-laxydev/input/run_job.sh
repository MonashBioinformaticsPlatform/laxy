...
readonly PIPELINE_VERSION="1.5.3"
readonly CONDA_ENV_SUFFIX="laxydev"
...
readonly LAXYDL_BRANCH=feature/custom-genomes
...
init_conda_env "rnasik" "${PIPELINE_VERSION}-${CONDA_ENV_SUFFIX}" || exit 1
